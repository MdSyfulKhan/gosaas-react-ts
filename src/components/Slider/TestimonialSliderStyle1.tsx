...
interface TestimonialSliderStyle1Props {
	testimonial: TestimonialItem[];
}

const TestimonialSliderStyle1: FC<TestimonialSliderStyle1Props> = ({
	testimonial,
}) => {
	...
	// Bind pagination element after mount and whenever swiper instance becomes available
	useEffect(() => {
	...
	}, [swiperRef.current, paginationRef.current]);
			...
			>
				{testimonial?.map((item, index) => (
					<SwiperSlide
						...
						key={index}
						style={{ width: "536px", transition: "width 0.3s ease" }}
					>
